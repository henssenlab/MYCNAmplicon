...
wgs_cov = plyranges::read_bigwig("/Volumes/Elements/nb-cl-wgs/nb-cl-wgs-bam/CHP-212_IlluminaWGS.hg19.rmdup.fixRG.bw")
...
out_vcf = "/Volumes/Elements/nb-cl-wgs/playground/CHP-212.svaba.unfiltered.sv.vcf.chr2_10M_80M.vcf" # needs to be a vcf
...
gt.copynumber = gTrack(cnv, y.field = "copy.number", y0=0, y1=200)
gt.H3K27ac = make_bigwig_gTrack("/Volumes/Elements/nb-cl-chipseq-results/bam/Boeva_CHP212_H3K27ac.trimmed.bwa_hg19.rmdup.filtered.bw", name = "H3K27ac", y0=0, y1=15)
gt.CTCF = make_bigwig_gTrack("/Volumes/Elements/nb-cl-chipseq-results/bam/MundlosLab_CHP-212_CTCF.trimmed.bwa_hg19.rmdup.filtered.bw", name = "CTCF", y0=0, y1=30)
gt.4C = gTrack("/Volumes/Elements/Virtual4C/CHP_hg19_canonical_MAPQ30_merged.hic.MYCN4C_Aug28.Normalization_KR_Viewpoint_16075000_16085000_Res_5000.bw", bar=TRUE, name = "v4C", y0=0,y1=0.5)
...
pdf("/Volumes/Elements/MYCNAmplicon/Results/CHP212_Reconstruction_Dec11.pdf", height=12, width=7, onefile=F, useDingbats = F)
plot(c(gencode, gt.se, gt.copynumber, reconstruction.gt, gt.H3K27ac, gt.CTCF, gt.4C, gt.hic), window,
     y.grid.col=F, y.grid.lwd=F, sep.lwd=0, sep.col=F, yaxis.pretty = 1)
dev.off()

save.image("/Volumes/Elements/MYCNAmplicon/Workspace/CHP212Reconstruction_Nov26.Rdata")
load("/Volumes/Elements/MYCNAmplicon/Workspace/CHP212Reconstruction_Nov26.Rdata")

longest_walk_nodups$grl %>% 
  as_tibble() %>% 
  write.table("/Volumes/Elements/MYCNAmplicon/Results/CHP212_Reconstruction.txt",
              sep="\t", quote=F)
