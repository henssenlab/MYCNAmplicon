...
ggsave("/Volumes/Elements/MYCNAmplicon/Results/TFMotifs.pdf",
       egg::ggarrange(
         ...
         ggplot() + theme_void(),
         plot_tf(phox2b_hits, "PHOX2B", roi, tf_color=RColorBrewer::brewer.pal(7, "Spectral")[1]) + theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank(), axis.line.x=element_blank()), 
         plot_tf(hits_gr_all, "GATA3", roi, tf_color=RColorBrewer::brewer.pal(7, "Spectral")[2]) + theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank(), axis.line.x=element_blank()), 
         plot_tf(hand2_hits, "HAND2", roi, tf_color=RColorBrewer::brewer.pal(7, "Spectral")[3]) + theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank(), axis.line.x=element_blank()),
         plot_tf(isl1_hits, "Isl1", roi, tf_color=RColorBrewer::brewer.pal(7, "Spectral")[4]) + theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank(), axis.line.x=element_blank()), 
         plot_tf(hits_gr_all, "TBX2", roi, tf_color=RColorBrewer::brewer.pal(7, "Spectral")[5]) + theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank(), axis.line.x=element_blank()), 
         plot_tf(hits_gr_all, "ASCL1", roi, tf_color=RColorBrewer::brewer.pal(7, "Spectral")[6]) + theme(axis.text.x=element_blank(), axis.title.x=element_blank(), axis.ticks.x=element_blank(), axis.line.x=element_blank()), 
         plot_tf(hits_gr_all, "MYCN", roi, tf_color=RColorBrewer::brewer.pal(7, "Spectral")[7]),
         nrow = 11,
         heights = c(1,0.5,1,0.25, rep(1,7)),
         labels = c("Genes","", "Enh", "", "PHOX2B", "GATA3", "HAND2", "ISL1", "TBX2", "ASCL1", "MYCN"),
