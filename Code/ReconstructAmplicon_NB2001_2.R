...
window = GRanges(
  ...
  ranges = IRanges(start=c(1,1),
                   end=c(seqlengths(BSgenome.Hsapiens.UCSC.hg19)[1],seqlengths(BSgenome.Hsapiens.UCSC.hg19)[2] ))
)
...
pdf("/Volumes/Elements/MYCNAmplicon/Results/NBL2001.pdf", height=7, width=7, onefile=F, useDingbats = F)
